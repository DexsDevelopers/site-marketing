...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .f-card h3 { margin-bottom: 1rem; font-size: 1.5rem; }
        .f-card p { color: var(--text-dim); }
        ...
        .privacy-content h2 { font-size: 2.5rem; margin-bottom: 1rem; }
        ...
        .user-img { width: 50px; height: 50px; border-radius: 50%; background: #333; }

        /* Dashboard Styles (Visible only when logged in) */
        .dash-container { display: none; padding: 4rem 0; }
        <?php if ($isLoggedIn): ?>
    ...
    <div class="container landing-container">
        ...
        <section class="privacy-highlight animate" id="privacy">
           <div style="position: relative;">
                <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="Privacy" width="200" style="filter: hue-rotate(90deg) brightness(1.5);">
                <div style="position: absolute; bottom: -10px; right: -10px; background: #fff; color: #000; padding: 5px 10px; border-radius: 8px; font-weight: 800; font-size: 0.7rem; border: 2px solid var(--primary);">NÚMERO 100% SEGURO</div>
            </div>
            <div class="privacy-content">
                ...
                <p style="font-size: 1.1rem; color: var(--text-dim); margin-bottom: 1.5rem;">
                    Nossa tecnologia foi desenvolvida para isolar completamente o motor de envio das suas informações pessoais. Garantimos que nada acontece com seu WhatsApp pessoal.
                </p>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    <div style="display: flex; gap: 10px; align-items: start;">
                        <i class="fas fa-lock" style="color: var(--primary); margin-top: 5px;"></i>
                        <span><b>Privacidade Total:</b> Não acessamos, não lemos e não salvamos nenhuma de suas conversas.</span>
                    </div>
                    <div style="display: flex; gap: 10px; align-items: start;">
                        <i class="fas fa-user-shield" style="color: var(--primary); margin-top: 5px;"></i>
                        <span><b>Seus Contatos a Salvo:</b> Jamais enviaremos mensagens para seus amigos, família ou grupos pessoais.</span>
                    </div>
                    <div style="display: flex; gap: 10px; align-items: start;">
                        <i class="fas fa-check-double" style="color: var(--primary); margin-top: 5px;"></i>
                        <span><b>Uso Invisível:</b> O sistema trabalha em "segundo plano" sem interferir no seu uso diário do app.</span>
                    </div>
                    <div style="display: flex; gap: 10px; align-items: start;">
                        <i class="fas fa-shield-virus" style="color: var(--primary); margin-top: 5px;"></i>
                        <span><b>Zero Risco:</b> Protocolo anti-banimento avançado mantém seu número protegido e saudável.</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="feedbacks">
            ...
            <div class="f-grid">
                <div class="testimonial">
                    ...
                    <div class="user-info">
                        <div class="user-img" style="background: url('https://i.pravatar.cc/150?u=1') center/cover;"></div>
                ...
                <div class="testimonial">
                    ...
                    <div class="user-info">
                        <div class="user-img" style="background: url('https://i.pravatar.cc/150?u=2') center/cover;"></div>
                ...
                <div class="testimonial">
                    ...
                    <div class="user-info">
                        <div class="user-img" style="background: url('https://i.pravatar.cc/150?u=3') center/cover;"></div>
        ...
        <footer style="padding: 4rem 0; border-top: 1px solid rgba(255,255,255,0.05); text-align: center; color: var(--text-dim);">
    ...
    <div class="container dash-container">
        <nav>
            ...
            <div style="display: flex; gap: 1.5rem; align-items: center;">
                <span>Olá, <b><?= htmlspecialchars($_SESSION['user_username']) ?></b></span>
        ...
        <div class="dash-grid">
            <div class="premium-panel animate">
                <div style="display:flex; justify-content: space-between; align-items: center;">
                    <h2>Conexão Ativa</h2>
                    <div id="status-tag" style="padding: 5px 15px; border-radius: 50px; font-size: 0.8rem; font-weight: 700;">OFFLINE</div>
                </div>
                
                <div id="qr-display-area" style="text-align: center; padding: 2rem 0;">
                    <p style="color: var(--text-dim); margin-bottom: 2rem;">Aponte seu WhatsApp para o código abaixo para começar a faturar.</p>
                    ...
                    <div style="margin-top:2rem; font-size:0.8rem; color:var(--text-dim); background:rgba(255,255,255,0.02); padding:1rem; border-radius:12px;">
                        <i class="fas fa-shield-alt" style="color:var(--primary)"></i> <b>Segurança Ativa:</b> Suas conversas e contatos pessoais estão protegidos e não serão acessados.
                    </div>
                </div>

                <div id="online-display-area" style="display: none; text-align: center; padding: 4rem 0;">
                    <div style="font-size: 5rem; color: var(--primary); margin-bottom: 2rem;"><i class="fas fa-check-circle shadow-glow"></i></div>
                    <h2 style="font-size: 2.5rem;">Sua rede está ativa!</h2>
                    <p style="color: var(--text-dim); font-size: 1.1rem; max-width: 400px; margin: 0 auto;">Estamos processando campanhas através da sua conexão. Não desconecte para continuar ganhando.</p>
                </div>
            </div>
            ...
            <div style="display:flex; flex-direction: column; gap: 2rem;">
                ...
                <div class="premium-panel animate" style="animation-delay: 0.2s;">
                    ...
                    <div style="margin-top: 1.5rem;">
                        <label style="font-size: 0.8rem; color: var(--text-dim);">Chave PIX (CPF, E-mail ou Celular)</label>
                ...
                <div class="premium-panel animate" style="animation-delay: 0.3s;">
                    ...
                    <div style="margin-top: 1.5rem;">
                        ...
                        <div style="height: 10px; background: rgba(255,255,255,0.05); border-radius: 10px; overflow: hidden;">
                            <div id="uptime-bar" style="height: 100%; background: var(--primary); width: 0%; transition: 1s;"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        async function loadDash() {
            try {
                ...
                if (d.instancia) {
                    ...
                    const p = Math.floor((s / 86400) * 100);
