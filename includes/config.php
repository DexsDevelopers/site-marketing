...
if (!headers_sent()) {
    ...
    header('Content-Security-Policy: default-src \'self\'; script-src \'self\' \'unsafe-inline\' \'unsafe-eval\' cdnjs.cloudflare.com cdn.tailwindcss.com cdn.jsdelivr.net; style-src \'self\' \'unsafe-inline\' cdnjs.cloudflare.com cdn.tailwindcss.com cdn.jsdelivr.net fonts.googleapis.com; font-src \'self\' fonts.gstatic.com cdnjs.cloudflare.com; img-src \'self\' data: blob:; connect-src \'self\';');
}
